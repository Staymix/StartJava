public class IfElseStatementTheme {
	public static void main(String[] args) {
		...
		boolean man = true;
		float hight = 1.88f;
		char one_letter_name = "Stas".charAt(0);
		if(age > 20){
		...
		one_letter_name = '\u0057';
		System.out.print(one_letter_name);
		if ((int) one_letter_name <= 47 || (int) one_letter_name == 64) {
				System.out.print(" символ");
		} else if ((int) one_letter_name <= 57) {
				System.out.print(" цифра");
		} else if ((int) one_letter_name <= 63) {
				System.out.print(" знак операции");
		} else if ((int) one_letter_name <= 90 && (int) one_letter_name != 64) {
				System.out.print(" большая буква");
		} else if ((int) one_letter_name <= 96) {
				System.out.print(" символ");
		} else if ((int) one_letter_name <= 122) {
				System.out.print(" маленькая буква");
		} else if ((int) one_letter_name <= 127) {
				System.out.print(" символ");
		} else if ((int) one_letter_name <= 159 || (int) one_letter_name == 240) {
				System.out.print(" большая буква");
		} else if ((int) one_letter_name <= 175 && (int) one_letter_name <= 239 && (int) one_letter_name > 223 
				|| (int) one_letter_name == 241) {
				System.out.print (" маленькая буква");
		} else if ((int) one_letter_name <= 223) {
				System.out.print(" символ");
		} else if ((int) one_letter_name <= 255) {
				System.out.print (" символ");
		}
		...
		System.out.println("Средний балл оценок по предметам " + ((GradePointAverage = histroryGrade + programmingGrade) / 2));
		System.out.println("Средний процент по предметам " + ((histroryPercent + programmingPercent) / 2));
		...
		if (isEnough) { 
				...
				System.out.println("Банкноты номиналом по 100 в количестве " + sumUSDHundred + 
						" шт на сумму " + sumUSDHundred * 100 + " USD");
				sumUSDHundred *= 100;
		} else if (!isEnough && (sumUSD / 100) != 0) {
				sumUSDHundred = ((sumUSD / 100) - ((sumUSD / 100) - billUSD100)) * 100;
				System.out.println("Банкноты номиналом по 100 в количестве " + billUSD100 + 
				...
				System.out.println("Банкноты номиналом по 10 в количестве " + sumUSDtens + 
						" шт на сумму " + sumUSDtens * 10 + " USD");
				sumUSD = sumUSD - (sumUSDtens * 10);
				sumUSDtens *= 10;
		} else if (!isEnough) {
				sumUSDtens = ((sumUSD / 10) - ((sumUSD / 10) - billUSD10)) * 10;
				System.out.println("Банкноты номиналом по 10 в количестве " + billUSD10 + 
				...
				System.out.println("Банкноты номиналом по 1 в количестве " + sumUSDones + 
						" шт на сумму " + sumUSDones + " USD");
				sumUSD = sumUSD - sumUSDones;
		} else if (!isEnough) {
				sumUSDones = sumUSD - (sumUSD - billUSD1);
				System.out.println("Банкноты номиналом по 1 в количестве " + billUSD1 + 
						" шт на сумму " + billUSD1 + " USD");
				sumUSD = sumUSD - billUSD1;
				billUSD1 = 0;
		} if (sumUSD == 0) {
			System.out.println("Купюры выданы на общую сумму " + (sumUSDones + sumUSDtens + sumUSDHundred));
		} else if (sumUSD != 0) {
